      ...
      <div class="column is-5">
        ...
        <div class="box">
          ...
          <div
            ...
            class="pm-empty has-text-centered"
          >
            <span class="pm-empty-chip">
              <FontAwesomeIcon :icon="faCreditCard" />
            </span>
            <p class="pm-empty-title">No cards yet</p>
            <p class="pm-empty-sub">
              Add a card to buy credits or claim free credits.
            </p>
            <button
          ...
          <!-- Add card section -->
          <div v-if="!showAddCard && methods.length" class="mt-3 has-text-centered">
            <button
          ...
          <div v-else-if="showAddCard" class="mt-4">
      ...
      <div class="column is-7">
        ...
        <div class="box" style="padding: 0; overflow: hidden">
          <progress
            ...
            max="100"
          ></progress>
          <div v-else-if="!purchases.length" class="pm-empty has-text-centered">
            <span class="pm-empty-chip">
              <FontAwesomeIcon :icon="faReceipt" />
            </span>
            <p class="pm-empty-title">No purchases yet</p>
            <p class="pm-empty-sub">Your credit purchases will appear here.</p>
          </div>
          <table
            v-else
...
import {
  ...
  type Purchase,
} from "~/composables/usePurchaseHistory";
...
const handleAddCard = async () => {
  ...
  try {
    ...
    if (result.error) {
      ...
      trackEvent("add_payment_info_error", {
        payment_type: "card",
        reason: addCardError.value,
      });
      return;
    }
...
/* Equal-height Connected Cards + Purchase History boxes */
.column {
  display: flex;
...
/* Neat empty states for cards + purchases (centered in the equal-height box) */
.pm-empty {
  margin-top: auto;
  margin-bottom: auto;
  padding: 2.5rem 1rem;
