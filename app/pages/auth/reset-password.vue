      ...
      <div class="login-card-container">
        <div class="login-card">
          ...
          <div class="login-content">
            ...
            <!-- State 2: New Password Form (token present) -->
            <template v-else>
              ...
              <template v-if="!passwordChanged">
                <form @submit.prevent="handleResetPassword" class="email-form">
                  <div class="form-field">
                    <input
                      v-model="newPassword"
                      type="password"
...
const { sendPasswordResetEmail, resetPassword, checkSession } =
  useSuperTokens();
...
const handleSendResetLink = async () => {
  ...
  try {
    ...
    if (response.status === "OK") {
      ...
      const fieldError = response.formFields?.[0]?.error;
      error.value = fieldError || "Failed to send reset link";
    } else {
...
const handleResetPassword = async () => {
  ...
  try {
    ...
    if (response.status === "OK") {
      ...
      const fieldError = response.formFields?.[0]?.error;
      error.value = fieldError || "Failed to reset password";
    } else {
