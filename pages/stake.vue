        ...
        <div class="modal-content">
          <div class="box">
            ...
            <div class="field has-addons">
              ...
              <p class="control">
                <button class="button is-medium is-primary" @click="prioFee = 10000" :class="{'is-outlined': prioFee !== 10000}">
                  <span>Fast</span>
                </button>
              </p>
              <p class="control">
                <button class="button is-medium is-primary" @click="prioFee = 50000" :class="{'is-outlined': prioFee !== 50000}">
                  <span>Turbo</span>
                </button>
              </p>
              <p class="control">
                <button class="button is-medium is-primary" @click="prioFee = 100000" :class="{'is-outlined': prioFee !== 100000}">
                  <span>Ultra</span>
                </button>
              </p>
            </div>
